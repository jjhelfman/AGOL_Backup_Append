...
source_csv = input("Please enter the source file location: ") # C:/KML to Maps/Exports/Preserves_FeatureToPoint.csv
...
def append_to_layer(gis, layer_url, item_csv):
    try:
        ...
        feature_layer.append(item_id=item_csv.id,
                            ...
                            rollback=True,
                            skip_inserts=False)
        print("Successfully appended to " + feature_layer + f" in {gis}")
