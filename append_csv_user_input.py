...
source_csv = input(
    "Please enter the source csv file location: "
)  # C:/KML to Maps/Exports/Preserves_FeatureToPoint.csv
source_name = input("Please enter the csv file name: ")  # i.e. Preserves_FeatureToPoint
source_tags = input("Please enter the csv file tags: ")  # i.e. Test, Preserves, CSV
source_desc = input(
    "Please enter the csv file description: "
)  # UCO points of interest in CSV
layer_url = input(
        ...
        for z in csv_fields1:
            if z in layer_fields1:
                ...
                field_mappings.append(
                    {"source": csv_fields[i_csv], "name": feat.fields[i_layer]}
                )
